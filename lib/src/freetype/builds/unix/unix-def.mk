...
#
prefix       := /home/6im1/jhaudego/Documents/COURS/Semestre_02/Synthese_Image/TEST_LIB2/lib/build
exec_prefix  := ${prefix}
...
REQUIRES_PRIVATE   := zlib, libpng, harfbuzz >= 1.3.0
LIBS_PRIVATE       := -lbz2
LIBSSTATIC_CONFIG  := -lfreetype -lz -lbz2 -lpng16 -lm -lz -lm -lharfbuzz -lglib-2.0 -pthread -lpcre -pthread -lgraphite2
build_libtool_libs := 
ft_version         := 23.0.17
